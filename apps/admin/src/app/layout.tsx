...
export const metadata = { title: "Kairos Digital — Admin", description: "Painel super admin" };
        ...
        <div className="flex min-h-screen">
          <aside className="w-60 bg-slate-950 p-4 ring-1 ring-slate-800">
            <div className="mb-8 flex items-center gap-2 text-lg font-bold">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600">K</span>
              Kairos Admin
            </div>
